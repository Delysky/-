...
f_temp1 = open("实体词统计/非敏感.txt", "w", encoding="utf8")
...
f_shiti = open('实体词统计/实体词1-ltp-重敏感.txt', 'a', encoding='UTF-8', errors='ignore')
...
# 对data_part2进行处理
# f_w = open("实体词统计/实体词.txt", "w", encoding="utf8")
f_shiti = open('实体词统计/实体词1-ltp-非敏感.txt', 'a', encoding='UTF-8', errors='ignore')
